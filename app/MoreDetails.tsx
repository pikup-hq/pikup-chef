          ...
          <View style={{ flex: 1 }}>
            ...
            <ScrollView
              ...
              contentContainerStyle={{
                paddingVertical: Spacing,
                paddingBottom: Platform.OS === "ios" ? 100 : 20, // Add extra padding at bottom
              }}
            ...
            >
              ...
              <View style={{ marginBottom: Spacing * 2 }}>
                <View style={{ flexDirection: "row", gap: 16 }}>
                  <View style={{ flex: 1 }}>
                    <MediumText style={{ marginBottom: 8 }}>
                      Opening Time
                    </MediumText>
                    <TouchableOpacity
                      style={{
